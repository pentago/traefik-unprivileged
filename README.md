...
Approach here is to fetch the official image binary, and copy over the binary to a alpine-based image with bare minimum of packages (*root certificates and zoneinfo*), running as unprivileged user (`1000:1000`) by default, all making it smaller and more secure.
